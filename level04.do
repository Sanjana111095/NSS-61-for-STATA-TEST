...
* EXTRACT LEVEL 04 DATA

foreach x  in 12 22 32 42 52 62 72 82 {
infile using "E:\Teaching\AUD\MA Econometrics\Econometrics stata assignment 1\dict\level04", using ("E:\Teaching\AUD\MA Econometrics\Econometrics stata assignment 1\raw\AH`x'.txt")
keep if level=="04"
compress
